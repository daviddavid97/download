...
inoremap <silent> <SNR>98_AutoPairsReturn =AutoPairsReturn()
map  
...
vmap \rr :call Compile_Run_Code()
nmap \rr :call Compile_Run_Code()
nmap \html :se ft=html
nmap \css :se ft=css
nmap \js :se ft=javascript
nmap \eruby :se ft=eruby
nmap \ruby :se ft=ruby
nmap \php :se ft=php
nmap \ev :e $MYVIMRC
vmap \wa \ww:VimwikiAll2HTML:qa
nmap \wa \ww:VimwikiAll2HTML:qa
...
vmap \rm :%s///g
nmap \rm :%s///g
vmap \rb :let _s=@/|:%s/\s\+$//e|:let @/=_s|:nohl
...
imap \rr :call Compile_Run_Code()
imap \html :se ft=htmlli
imap \css :se ft=cssli
imap \js :se ft=javascriptli
imap \eruby :se ft=erubyli
imap \ruby :se ft=rubyli
imap \php :se ft=phpli
imap \wa \ww:VimwikiAll2HTML:qa
imap \th :set nonumber:set norelativenumber:TOhtml:w %:r.html:q:set number:set relativenumber
imap \rm :%s///g
...
silent only
cd ~/IdeaProjects/download/src/com/company
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/IdeaProjects/download/src/com/company/MutilDown.java
badd +0 ~/IdeaProjects/download/src/com/company/DownThread.java
badd +0 ~/IdeaProjects/download/src/com/company/Main.java
argglobal
silent! argdel *
argadd MutilDown.java
edit ~/IdeaProjects/download/src/com/company/Main.java
...
argglobal
enew
file ~/IdeaProjects/download/src/com/company/NERD_tree_2
let s:cpo_save=&cpo
set cpo&vim
